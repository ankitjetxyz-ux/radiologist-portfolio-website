...
export const otherProducts: OtherProduct[] = [
  ...
  {
    id: "sony-normal-roll",
    name: "Sony Normal Roll",
    description: "Standard thermal paper for Sony medical printers in ultrasound and endoscopy workflows.",
    category: "Endoscopy Media",
    image: "/images/radiology/rad-04-print-films.png",
  },
  {
    id: "sony-glossy-roll",
    name: "Sony High Glossy Roll",
    description: "High-gloss thermal media for premium image presentation on Sony UP-series printers.",
    category: "Endoscopy Media",
    image: "/images/radiology/rad-10-blue-medical-film.png",
  },
  {
